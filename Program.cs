...
namespace Questao1 {
    class Program {
        static void Main(string[] args) {
            ...
            ContaBancaria conta = new ContaBancaria();//vini
            ...
            if (resp == 's' || resp == 'S') {
                ...
                //vini conta = new ContaBancaria(numero, titular, depositoInicial);
            }
            else {
                //vini conta = new ContaBancaria(numero, titular);
            }
